...
3. 1. Sin materiales registrados
        1. El sistema no encuentra materiales en el stock.
        2. El sistema muestra un mensaje: "No hay materiales registrados".
        3. El usuario puede optar por registrar un nuevo material.

     2. Error al cargar el stock
        1. El sistema no puede obtener los datos del stock.
        2. El sistema muestra un mensaje de error: "No fue posible cargar el stock".
        3. El sistema ofrece la opción de reintentar la operación.

## Postcondiciones:
El usuario visualiza el estado actual del stock.
