...
3. El usuario selecciona un material y elige la opción "Eliminar".
4. El sistema solicita confirmación.
5. EL usuaruo confirma la eliminación
6. EL sistema elimina el material, actualiza el listado y muestra un mensaje de confirmación.
